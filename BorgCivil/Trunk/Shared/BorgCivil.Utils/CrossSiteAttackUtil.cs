...
namespace BorgCivil.Utils
{
    ...
    public static class CrossSiteAttackUtil
    {
        ...
        public static string ReplaceNewLines(string street)
        {
            if (string.IsNullOrEmpty(street))
            {
                return street;
            }
            street = street.TrimEnd('\r').TrimEnd('\n');
            street = street.Replace(Environment.NewLine, "<br />");
            return street;
        }

        public static string AddNewLines(string street)
        {
            if (string.IsNullOrEmpty(street))
            {
                return street;
            }
            street = street.Replace("<br />", Environment.NewLine);
            return street;
        }
    }
}